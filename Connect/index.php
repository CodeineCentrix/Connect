...
<h5 class="company_font  normal_text">4 - 5th August 2018</h5>
        </div> 
        <br>
	...
	$('.countdown').final_countdown();
        ...
        <div class="birthday-holder">
            ...
            <div class="birthday_gallery_holder">
                <a href="gallery.php"> <p class="company_font section_two normal_text">Follow our journey <span class=" fa fa-heart"></span></p></a>
            </div>
        </div>
        ...
        <div class="get_start_holder">
            <div class="get_start_content">
                ...
                <p>Tickets are now sold at the venue<br>
                   Per Day : &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; R50<br>
                   Weekend Pass:&nbsp;&nbsp;R80
                </p>
            </div>
        ...
        <div class="stakeholder">
            ...
            <div class="card">
                <img src="pics/maria.jpg" alt="John" style="width:100%">
            <h1>Maria Jonas</h1>
            <p class="title">Kids Toys</p>
            <p>Vendor Stall 11</p>
            <a href="#"><i class="fa fa-dribbble"></i></a> 
            <a href="#"><i class="fa fa-twitter"></i></a> 
            <a href="#"><i class="fa fa-linkedin"></i></a> 
            <a href="https://www.facebook.com/anathi.matshaya"><i class="fa fa-facebook"></i></a> 
         
          </div>
            
            <div class="card">
                <img src="pics/phillip.jpg" alt="John" style="width:100%">
            <h1>Phillip Kitchen</h1>
            <p class="title">The Flash Costumes</p>
            <p>Vendor Stall 25</p>
            <a href="#"><i class="fa fa-dribbble"></i></a> 
            <a href="#"><i class="fa fa-twitter"></i></a> 
            <a href="#"><i class="fa fa-linkedin"></i></a> 
            <a href="https://www.facebook.com/davancy.legodi"><i class="fa fa-facebook"></i></a> 
            
          </div>
            
            <div class="card">
                <img src="pics/peter.jpg" alt="John" style="width:100%">
            <h1>Peter Johns</h1>
            <p class="title">Anime comic books</p>
            <p>Vendor Stall 32</p>
            <a href="#"><i class="fa fa-dribbble"></i></a> 
            <a href="#"><i class="fa fa-twitter"></i></a> 
            <a href="#"><i class="fa fa-linkedin"></i></a> 
            <a href="https://www.facebook.com/shervin.douwdies.7"><i class="fa fa-facebook"></i></a> 
        ...
        <div class="sponsors_holder">
            ...
            <br>
            <div class='round'>
                <img src='pics/18620.jpg' alt="Hunter" style="width: 200px; height: 200px; border-radius: 250px;" />   
                <p class="title" style="color:white; font-family:'New Drop Era'">Hunter x Hunter</p>
            </div>
            
            <div class='round'>
                <img src='pics/one_punch_vault_boy.jpg' alt="One Punch" style="width: 200px; height: 200px; border-radius: 250px;" />    
                <p class="title" style="color:white; font-family:'New Drop Era'">One Punch Man</p>
            </div>
            
            <div class='round'>
                <img src='pics/9860a8c2-rick-and-morty-header.jpg' alt="Rick and Morty" style="width: 200px; height: 200px; border-radius: 250px;" />  
                <p class="title" style="color:white; font-family:'New Drop Era' ">Rick & Morty</p>
            </div>
        </div>
    </body>
</html>
